...
<div class="mb-2">
    ...
    <a class="btn btn-primary btn-sm mr-2" href=" {{route('dashboard.categories.create')}} ">Create</a>
    @endcan
    @can('categories.trash')
    <a class="btn btn-secondary btn-sm mr-2" href=" {{route('dashboard.categories.trash')}} ">Trash</a>

    @endcan
</div>
<form action="{{ route('dashboard.categories.index') }}" class="d-flex justify-content-between mb-4">
        ...
        <tr>
            ...
            <td>
                ...
                -->
                    ...
                    <a href="{{route('dashboard.categories.show',$category->id)}}" class="btn btn-secondary btn-sm mr-1 ml-1">show</a>
                </div>
