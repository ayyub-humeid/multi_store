                                    ...
                                    <div class="select-position">
                                        <form action="{{ URL::current() }}" method="get">
                                            <select name="locale" onchange="this.form.submit()">
                                                ...
                                                @endforeach --}}
                                                <option value="ar" @selected('ar'==Cookie::get('locale'))>Ar</option>
                                                <option value="en" @selected('en'==Cookie::get('locale'))>En</option>
                                                <option value="fr" @selected('fr'==Cookie::get('locale'))>Fr</option>
                                            </select>
                                        </form>
                                    </div>
                                </li>
                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                <ul id="nav" class="navbar-nav ms-auto">
                                    <li class="nav-item">
                                        <a href="index.html" aria-label="Toggle navigation">{{ __('app.home') }}</a>
                                    </li>
                                    <li class="nav-item">
                                        ...
                                        <ul class="sub-menu collapse" id="submenu-1-2">
                                            <li class="nav-item"><a href="about-us.html">{{ __('app.about') }}</a></li>
                                            <li class="nav-item"><a href="faq.html">Faq</a></li>
                                            <li class="nav-item active"><a href="login.html">{{ __('app.signin') }}</a></li>
                                            <li class="nav-item"><a href="register.html">{{ __('app.regester') }}</a></li>
